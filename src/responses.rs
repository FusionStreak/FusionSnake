...
pub struct TurnRecord {
    ...
    pub target_food_distance: i32,
    pub target_food_contested: bool,
    pub max_enemy_length: i64,
    pub min_enemy_length: i64,
    pub length_advantage: i32,
    pub up_safety: i32,
    pub up_desirability: i32,
    pub up_space: i64,
    pub down_safety: i32,
    pub down_desirability: i32,
    pub down_space: i64,
    pub left_safety: i32,
    pub left_desirability: i32,
    pub left_space: i64,
    pub right_safety: i32,
    pub right_desirability: i32,
    pub right_space: i64,
    pub chosen_move: String,
    pub safety_weight: i32,
    pub food_weight: i32,
...
pub struct TrainingAverages {
    ...
    pub avg_health: f64,
    pub avg_length: f64,
    pub avg_up_safety: f64,
    pub avg_down_safety: f64,
    pub avg_left_safety: f64,
    pub avg_right_safety: f64,
    pub avg_up_space: f64,
    pub avg_down_space: f64,
    pub avg_left_space: f64,
    pub avg_right_space: f64,
    pub avg_food_distance: f64,
